...
const About = () => {
  return (
    <div className="pt-16 font-japanese-basic">
      ...
      <div className="p-8 tracking-wider bt-6">
        <h2 className="title-br-util text-2xl">ご挨拶</h2>
        ...
        <div className="text-sm leading-7">
          ...
          <p>
            ...
            <span>どんな小さなことでも、お気軽にご相談ください。</span>
          </p>
        </div>
      </div>
      <div className="bg-site-sub-color mt-4 p-8 tracking-wider">
        <h2 className="title-br-util text-2xl">経営理念</h2>
        ...
        <div className="mt-12">
          <Image
            className="transform opacity-60"
            src={philosophyImg}
            alt=""
          ></Image>
        </div>
      </div>
      <div className="mt-4 pb-14 p-8 tracking-wider">
        <h2 className="title-br-util text-2xl">会社概要</h2>
        <table
          className={`mt-6 w-full border-collapse company-about-table text-sm ${KLEE_ONE.className}`}
        >
          <tbody>
            <tr>
              <th>会社名</th>
